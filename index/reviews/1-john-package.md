# 1 John — review package

Scripture: World English Bible (public domain). Index status: complete. Method version 1.0.
...
**Note.** Four entries carry prior citations from C01 and C12, which serve as the calibration set for this book. 1 John uses the same verb of remaining that John 15 uses, so the abiding material here and in the Gospel are the same claim in two registers — one in parable, one in argument.

---

## 1. 1 John 1:1-4 — That which we have heard, seen, and handled
...
**Claim.** The claim is staked on sensory testimony rather than on revelation received privately — heard, seen, looked at, handled, in that order of increasing contact. The eyes are opened here by proximity to something, which is how C06 describes perception being trained rather than granted.

**Tags.** mode: exemplifies (someone in the passage does it) · pillars: truth · stages: S2 · chapters: C06 · practices: none · confidence: medium

---

## 2. 1 John 1:5-7 — God is light; walking in the light
...
**Claim.** Fellowship claimed while walking in darkness is named a lie outright. Already load-bearing in C12, and the test is behavioural rather than doctrinal — where a man walks, not what he affirms.
...
## 3. 1 John 1:8-10 — If we confess our sins
...
**Claim.** Self-deception is treated as the default and confession as the correction, with the deceiving done to oneself rather than to others. The Moral Audit's premise and the Failure Recovery Protocol's mechanism stated in three verses, and the promise attached is cleansing rather than mere pardon.
...
## 4. 1 John 2:1-6 — This is how we know that we know him
...
**Claim.** Knowledge of God given an observable test, and the man who claims it without keeping the commandments is called a liar in plain terms. C12's proof applied to the interior claim that is hardest to check from outside — and 2:6 makes the standard imitation of a walk, not assent to a proposition.
...
## 5. 1 John 2:7-11 — He who hates his brother is in the darkness
...
**Claim.** The commandment is called both old and new in consecutive verses, and then love of the brother is made the difference between walking in light and not knowing where one is going. Hatred is described as disorientation rather than as wickedness, which is the more useful diagnosis.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: mercy, truth · stages: S4 · chapters: C15 · practices: none · confidence: high

---

## 6. 1 John 2:12-14 — I write to you, fathers, young men, little children
...
**Claim.** Three groups addressed by maturity rather than by role, each given a different ground — forgiveness, knowing him from the beginning, having overcome. Formation treated as staged, with different words owed to people at different distances along it, which is the architecture C25 sets out.

**Tags.** mode: exemplifies (someone in the passage does it) · pillars: truth · stages: S6 · chapters: C25 · practices: PR14 · confidence: high

---

## 7. 1 John 2:15-17 — Don't love the world; the world is passing away
...
**Claim.** Three appetites named — of the flesh, of the eyes, and the pride of life — and set against what remains. Holy Detachment argued from transience rather than from asceticism: the objection is that these things are leaving, not that wanting them is base.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: humility · stages: S4 · chapters: C18 · practices: none · confidence: high

---

## 8. 1 John 2:18-27 — They went out from us; the anointing remains in you
...
**Claim.** Departure is treated as revealing what was already true rather than as causing a loss. The fruit test of C08 applied to teachers who were once inside, and the anointing is offered as the reader's own equipment for judging rather than a call to defer.
...
## 9. 1 John 2:28-3:3 — Remain in him; it is not yet revealed what we will be
...
**Claim.** The destination is explicitly withheld — what we will be has not appeared — and hope in that unknown is said to be what purifies. The Discipline of Unknowing given a forward direction, and remaining is the instruction issued in place of a description.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: truth, humility · stages: S3, S6 · chapters: C11, C26 · practices: PR04 · confidence: high

---

## 10. 1 John 3:4-10 — The children of God and the children of the devil are revealed
...
**Claim.** Practice, not profession, is what makes the distinction visible — the verb throughout is doing rather than believing. The hardest form of C12's proof test, and the seed that remains in a person is offered as the reason the change holds rather than as a threat.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: truth · stages: S3 · chapters: C12 · practices: none · confidence: high

---

## 11. 1 John 3:11-15 — Not like Cain; whoever hates his brother is a murderer
...
**Claim.** Cain's motive is stated flatly — his own works were evil and his brother's righteous — which traces the murder to envy rather than to grievance. Interior Diagnosis performed on the first killing, and hatred is then classed with it in kind rather than in degree.

**Tags.** mode: counter-example (the passage shows what its absence costs) · pillars: mercy · stages: S4, S5 · chapters: C15, C21 · practices: PR02 · confidence: high

---

## 12. 1 John 3:16-18 — Sees his brother in need and closes his heart
...
**Claim.** Already load-bearing in the curriculum. The test is possession, sight, and then the shutting of compassion — all three present before anything is withheld, which is what makes it culpable. Loving in deed and truth rather than in word is the standard Habitual Almsgiving is measured by.
...
## 13. 1 John 3:19-24 — If our heart condemns us, God is greater than our heart
...
**Claim.** Self-condemnation is answered not by denying the accusation but by placing something larger over it — God is greater than the heart, and knows all things. The single most important verse in Scripture for the Failure Recovery Protocol, because it addresses the case where the audit's verdict is accurate and still not final.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: mercy, humility · stages: S5 · chapters: C19 · practices: PR11 · confidence: high

---

## 14. 1 John 4:1-6 — Test the spirits
...
**Claim.** Testing is commanded rather than permitted, and the reason given is prevalence — many false prophets have gone out. C08's discipline stated as an obligation laid on ordinary believers rather than on those with office.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: truth · stages: S2 · chapters: C08 · practices: none · confidence: high

---

## 15. 1 John 4:7-12 — God is love; no one has seen God at any time
...
**Claim.** The invisible God is said to be made present by love between people — if we love one another, he remains in us. Abiding relocated from private interiority into the space between persons, which is the correction the curriculum needs against reading C11 as solitary.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: mercy · stages: S3, S7 · chapters: C11, C27 · practices: none · confidence: high

---

## 16. 1 John 4:13-16 — He who remains in love remains in God
...
**Claim.** The same verb the vine passage turns on, here with love as the place one remains rather than a person. C10 and C11 stated as a single claim in argument form, where the Gospel gave it as an image.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: mercy · stages: S3 · chapters: C10, C11 · practices: none · confidence: high

---

## 17. 1 John 4:17-21 — Perfect love casts out fear
...
**Claim.** Fear is displaced rather than suppressed, and its presence is read as a measure of how far love has been completed. The passage then closes the escape route: a man who claims to love God while hating his brother is called a liar, because the invisible cannot be loved by someone failing at the visible.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: mercy · stages: S5, S7 · chapters: C19, C27 · practices: PR15 · confidence: high

---

## 18. 1 John 5:1-5 — His commandments are not grievous
...
**Claim.** Already load-bearing in C01. The claim that the commandments are not burdensome is the whole argument that the Way of Life runs with the grain of things rather than against it — the road is demanding, and it is not heavy.
...
## 19. 1 John 5:6-12 — The Spirit, the water, and the blood
...
**Claim.** Three witnesses agreeing as one, with the testimony said to be held internally by the one who believes. Corroboration presented as the ordinary shape of assurance rather than as a concession to doubt.

**Tags.** mode: exemplifies (someone in the passage does it) · pillars: truth · stages: S3 · chapters: C12 · practices: none · confidence: medium

---

## 20. 1 John 5:13-17 — Ask, and he will give him life
...
**Claim.** Seeing a brother sin issues in prayer for him rather than in report or avoidance, and life is what the asker is told to expect. Merciful Reintegration begun at the point of noticing, before any repentance has occurred.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: mercy · stages: S4, S7 · chapters: C14, C29 · practices: PR29 · confidence: high

---

## 21. 1 John 5:18-21 — Keep yourselves from idols
...
**Claim.** The letter ends on a guarding instruction after five chapters of assurance, which is deliberate — the one born of God is said to keep himself. Watchfulness placed last rather than first, as the practice that protects what has been described.

**Tags.** mode: prescribes (the passage commands this practice) · pillars: truth · stages: S4, S5 · chapters: C18, C20 · practices: PR12 · confidence: high
